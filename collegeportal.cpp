...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<"          JAYPEE INSTITUTE OF INFORMATION TECHNOLOGY SECTOR-62 NOIDA"<<endl;
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"    JAYPEE INSTITUTE OF INFORMATION AND TECHNOLOGY    "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" CHARUSAT "<<r6<< r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    SECTOR 62,NOIDA.                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                          DEEMED TO BE UNIVERSITY UNDER SECTION 3 OF UGC ACT 1956       "<<r6<<endl;
        cout<<"\t"<<r6<<"                         "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
        ...
        for(int i=1;i<10;i++)
            cout<<r5;
        cout<<r12<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" 15B11MA211     MATHS              "<<r6<<"     "<<credits[0]<<"     "<<r6<<"   "<<setw(3)<<marks[0]<<"   "<<r6<<"   "<<gr[0]<<gr[0]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" 15B11EC111     ES                "<<r6<<"     "<<credits[1]<<"     "<<r6<<"   "<<setw(3)<<marks[1]<<"   "<<r6<<"   "<<gr[1]<<gr[1]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" 15B11PH211     PHYSICS              "<<r6<<"     "<<credits[2]<<"     "<<r6<<"   "<<setw(3)<<marks[2]<<"   "<<r6<<"   "<<gr[2]<<gr[2]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" 15B11CI211     SDF               "<<r6<<"     "<<credits[3]<<"     "<<r6<<"   "<<setw(3)<<marks[3]<<"   "<<r6<<"   "<<gr[3]<<gr[3]<<"    "<<r6<<" "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" 22B12HS111     LIFESKILLS              "<<r6<<"     "<<credits[4]<<"     "<<r6<<"   "<<setw(3)<<marks[4]<<"   "<<r6<<"   "<<gr[4]<<gr[4]<<"    "<<r6<<" "<<r6<<endl;
         cout<<"\t"<<r6<<" "<<r2;
        for(int i=1;i<30;i++)
            cout<<r5;
        cout<<r8;
    ...
    void salary_certy(string id)
{
     ifstream f1;
        ...
        for(int i=1;i<67;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"  JAYPEEE INSTITUTE OF INFORMATION AND TECHNOLOGY    "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" JIIT "<<r6<<"            "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    SECTOR , 62                   "<<r6<<endl;
        cout<<"\t"<<r6<<"                         DEEMED TO BE UNIVERSITY UNDER SECTION 3 OF UGC ACT 1956          "<<r6<<endl;
        cout<<"\t"<<r6<<"                        "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                  "<<r6<<endl;
...
int main()
{
    char x=221,Y=222;
    FTE f;
    cout<<"\n\n\n\n\n\n\n\n\n\t\t\t\t      "<<x<<"  WELCOME TO COLLEGE PORTAL  \a"<<Y<<"\n\n\n\n\n\n\n\n\n";
    getch();
    A:
    {
    system("cls");
        ...
        case 0:
            {
                ...
                system("cls");
                cout<<"\n\n\tPREPARED BY:-"<<endl;
                cout<<"\n\t"<<x<<" STUTI SRIJAN      22803011";
                cout<<"\n\t"<<x<<" UJJAWAL GARG      22803019";
                cout<<"\n\t"<<x<<" GAURANGI TYAGI    20803012";
                cout<<"\n\t"<<x<<" HARLEEN KAUR      22803009\n\n\n\n\n";
                getch();
                goto E;
                break;
            }
